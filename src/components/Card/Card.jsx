...
import './card.scss'
import sneakers from '../../image/card/sneakers_card.png'
        ...
        <div className='card_bin_main'>
            <div className="card_bin__item">
                ...
                <div className="card_bin__item_desc">
                    <div className="desc__title">Nike ZoomX 2023</div>
                    <div className="desc__category">Sneakers</div>
                </div>

                <div className="card_bin__item_price">99$</div>
