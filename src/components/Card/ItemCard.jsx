...
import { removeProduct } from '../../feature/cards/cardsSlice'
import './card.scss'
...
export const ItemCard = ({
    ...
    return <div className="card_bin__item">
        ...
        <div className="card_bin__item_desc">
            <div className="desc__title">{title}</div>
            <div className="desc__category">{category.name}</div>
        </div>

        <div className="card_bin__item_price">{price}$</div>

        <div className="card_bin__item_quentity">
            {/* или же сделать толко через state */}
            <button className='minus' onClick={() => setCountProduct(countProduct - 1)}>
            ...
            <span className="count">{countProduct}</span>

            <button className="plus" onClick={() => setCountProduct(countProduct + 1)}>
        ...
        <div className="card_bin__item_new_price">99$</div>

        <div className="close" onClick={() => deleteProduct(id)}>
